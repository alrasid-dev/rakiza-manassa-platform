...
<body>
  <div class="page">
    ...
    <div class="step"><div class="num">١</div><div><h3>تسجيل الدخول — الرقم الموحد</h3><p>عبر البريد المؤسسي الرسمي (@moj.gov.sa) للوصول التلقائي للوحدة التنظيمية التابعة لك.</p><ul><li><b>الدخول الأول:</b> أدخل بريدك الرسمي ثم الرقم الموحد <b dir="ltr">759111</b> للدخول لأول مرة.</li><li><b>إنشاء الرمز الشخصي:</b> بعد الدخول بالرقم الموحد، أنشئ رمزك الشخصي الجديد من 6 أرقام ليحلّ محل الرقم الموحد، وأكّده ثم اضغط «حفظ الرمز ومتابعة الدخول».</li><li><b>الدخول اليومي:</b> أدخل بريدك الرسمي ثم رمزك الشخصي (6 أرقام) واضغط «دخول».</li><li><b>تغيير الرمز:</b> اطلب من مالك المنصة إعادة التعيين، ثم أعد الدخول بالرقم الموحد وأنشئ رمزاً جديداً.</li></ul></div></div>
