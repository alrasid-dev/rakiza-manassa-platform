...
<body>
  <div class="page">
    ...
    <div class="step"><div class="num">١</div><div><h3>تسجيل الدخول</h3><p>عبر البريد المؤسسي الرسمي (@moj.gov.sa) للوصول التلقائي للوحدة التنظيمية التابعة لك.</p><ul><li><b>الدخول الأول:</b> بعد إدخال بريدك الرسمي، أنشئ «رمز المرور» الخاص بك من 6 أرقام، وأكّده ثم اضغط «حفظ الرمز ومتابعة الدخول».</li><li><b>الدخول اليومي:</b> أدخل بريدك الرسمي ثم رمز المرور (6 أرقام) واضغط «دخول».</li><li><b>تغيير الرمز:</b> اطلب من مالك المنصة إعادة تعيين رمزك، ثم أنشئ رمزاً جديداً في الدخول التالي.</li></ul></div></div>
